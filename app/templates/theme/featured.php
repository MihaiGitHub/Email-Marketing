			...
			<tr><td align="center">
				...
				<div style="line-height: 44px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
						<div id="block5" contenteditable="true">Awesome User Expierence</div>
					</span></font>
				</div>
					...
					<table class="mob_100" width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style="border-collapse: collapse;">
						<tr><td align="center" style="line-height: 14px; padding: 0 27px;">
							...
							<div style="line-height: 14px;">
								<font face="Arial, Helvetica, sans-serif" size="3" color="#4db3a4" style="font-size: 14px;">
								<strong style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #4db3a4;">
									<div id="block10" contenteditable="true"><a href="#2" target="_blank" style="color: #4db3a4; text-decoration: none;">GREAT SUPPORT</a></div>
								</strong></font>
							</div>
							<!-- padding --><div style="height: 18px; line-height: 18px; font-size: 10px;">&nbsp;</div>
							<div style="line-height: 21px;">
								<font face="Arial, Helvetica, sans-serif" size="3" color="#98a7b9" style="font-size: 14px;">
								<span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #98a7b9;">
									<div id="block11" contenteditable="true">Lorem ipsum dolor sit amet consectetuer sed et diam noumy elit dolore</div>
								</span></font>
							</div>
						</td></tr>
					</table>
					...
					<table class="mob_100" width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style="border-collapse: collapse;">
						<tr><td align="center" style="line-height: 14px; padding: 0 27px;">
							...
							<div style="line-height: 14px;">
								<font face="Arial, Helvetica, sans-serif" size="3" color="#4db3a4" style="font-size: 14px;">
								<strong style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #4db3a4;">
									<div id="block12" contenteditable="true"><a href="#3" target="_blank" style="color: #4db3a4; text-decoration: none;">CLEAN CODE</a></div>
								</strong></font>
							</div>
							<!-- padding --><div style="height: 18px; line-height: 18px; font-size: 10px;">&nbsp;</div>
							<div style="line-height: 21px;">
								<font face="Arial, Helvetica, sans-serif" size="3" color="#98a7b9" style="font-size: 14px;">
								<span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #98a7b9;">
									<div id="block13" contenteditable="true">Lorem ipsum dolor sit amet consectetuer sed et diam noumy elit dolore</div>
								</span></font>
							</div>
						</td></tr>
					</table>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr><td align="center">
						...
						<span style="font-family: Arial, Helvetica, sans-serif; font-size: 26px; color: #57697e;">
							<div id="block15" contenteditable="true">Featured Works</div>
						</span></font>				
					</td></tr>			
				</table>				
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					<div id="block23" contenteditable="true">2015 &copy; Metronic. ALL Rights Reserved.</div>
				</span></font>				
			</td></tr>			
		</table>
