			...
			<tbody><tr><td align="center">
				...
				<div style="line-height: 44px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
						<div id="block5" contenteditable="true">Welcome to the Metronic</div>
					</span></font>
				</div>
				<!-- padding --><div style="height: 30px; line-height: 30px; font-size: 10px;">&nbsp;</div>
			</td></tr>
			<tr><td align="center">
				<div style="line-height: 30px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #4db3a4;">
						<div id="block6" contenteditable="true">Hi Dylan, your registration is completed!</div>
					</span></font>
				</div>
							...
							<tbody><tr><td align="center">
								<div style="line-height: 24px;">
									...
									<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
										<div id="block7" contenteditable="true">Lorem ipsum dolor sit amet consectetuer adipiscing elit, sed diam nonumy nibh elit esmod tincidunt ut laoreet dolore magna aliquam volutpat wisi enim ad minim veniam quis dolore.</div>
									</span></font>
								</div>
							</td></tr>
						</tbody></table>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tbody><tr><td align="center">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					<div id="block10" contenteditable="true">2015 © Metronic. ALL Rights Reserved.</div>
				</span></font>				
			</td></tr>			
		</tbody></table>
