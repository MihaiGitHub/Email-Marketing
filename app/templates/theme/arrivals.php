				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr><td align="center">
						...
						<span style="font-family: Arial, Helvetica, sans-serif; font-size: 22px; color: #57697e; text-transform: uppercase;">
							<div id="block3" contenteditable="true">Newest Products</div>
						</span></font>
						<!-- padding --><div style="height: 40px; line-height: 40px; font-size: 10px;">&nbsp;</div>
					</td></tr>			
				</table>
								...
								<tr><td align="center" style="line-height: 14px; padding: 0 25px;">
									<div style="border-width: 1px; border-style: solid; border-color: #eff2f4;">
                                        ...
                                        <div id="block4" contenteditable="true">
											<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
												<font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">
													<img src="http://artloglab.com/metromail-shop/images/goods1.jpg" width="272" alt="Goods 1" border="0" style="display: block; width: 100%; height: auto;" /></font></a></div>
										</div>
										...
										<div style="line-height: 21px; padding: 0 10px;">
											...
											<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #727272; text-transform: uppercase;">
												<div id="block5" contenteditable="true"><a href="#" target="_blank" style="color: #727272; text-decoration: none;">Lorem ipsum dolor sit</a></div>
											</span></font>
										</div>
										...
										<div style="line-height: 21px; padding: 0 10px;">
											...
											<strong style="font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 18px; color: #727272;">
												<div id="block6" contenteditable="true">$150</div>
											</strong></font>
										</div>
								...
								<tr><td align="center" style="line-height: 14px; padding: 0 25px;">
									<div style="border-width: 1px; border-style: solid; border-color: #eff2f4;">
                                        ...
                                        <div id="block7" contenteditable="true">
											<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
												<font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">
													<img src="http://artloglab.com/metromail-shop/images/goods2.jpg" width="272" alt="Goods 2" border="0" style="display: block; width: 100%; height: auto;" /></font></a></div>
										</div>
										<!-- padding --><div style="height: 20px; line-height: 20px; font-size: 10px;">&nbsp;</div>
										<div style="line-height: 21px; padding: 0 10px;">
											<font face="Arial, Helvetica, sans-serif" size="3" color="#727272" style="font-size: 15px;">
											<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #727272; text-transform: uppercase;">
												<div id="block8" contenteditable="true"><a href="#" target="_blank" style="color: #727272; text-decoration: none;">Consectetuer sed et diam</a></div>
											</span></font>
										</div>
										<!-- padding --><div style="height: 5px; line-height: 5px; font-size: 10px;">&nbsp;</div>
										<div style="line-height: 21px; padding: 0 10px;">
											<font face="Arial, Helvetica, sans-serif" size="5" color="#727272" style="font-size: 18px;">
											<strong style="font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 18px; color: #727272;">
												<div id="block9" contenteditable="true">$400</div>
											</strong></font>
										</div>
										<!-- padding --><div style="height: 30px; line-height: 30px; font-size: 10px;">&nbsp;</div>
									</div>
								...
								<tr><td align="center" style="line-height: 14px; padding: 0 25px;">
									<div style="border-width: 1px; border-style: solid; border-color: #eff2f4;">
                                        ...
                                        <div id="block10" contenteditable="true">
											<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
												<font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">
													<img src="http://artloglab.com/metromail-shop/images/goods3.jpg" width="272" alt="Goods 3" border="0" style="display: block; width: 100%; height: auto;" /></font></a></div>
										</div>
										<!-- padding --><div style="height: 20px; line-height: 20px; font-size: 10px;">&nbsp;</div>
										<div style="line-height: 21px; padding: 0 10px;">
											<font face="Arial, Helvetica, sans-serif" size="3" color="#727272" style="font-size: 15px;">
											<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #727272; text-transform: uppercase;">
												<div id="block11" contenteditable="true"><a href="#" target="_blank" style="color: #727272; text-decoration: none;">Diam nonumy nibh</a></div>
											</span></font>
										</div>
										<!-- padding --><div style="height: 5px; line-height: 5px; font-size: 10px;">&nbsp;</div>
										<div style="line-height: 21px; padding: 0 10px;">
											<font face="Arial, Helvetica, sans-serif" size="5" color="#727272" style="font-size: 18px;">
											<strong style="font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 18px; color: #727272;">
												<div id="block12" contenteditable="true">$320</div>
											</strong></font>
										</div>
										<!-- padding --><div style="height: 30px; line-height: 30px; font-size: 10px;">&nbsp;</div>
									</div>
								...
								<tr><td align="center" style="line-height: 14px; padding: 0 25px;">
									<div style="border-width: 1px; border-style: solid; border-color: #eff2f4;">
                                        ...
                                        <div id="block13" contenteditable="true">
											<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
												<font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">
													<img src="http://artloglab.com/metromail-shop/images/goods4.jpg" width="272" alt="Goods 4" border="0" style="display: block; width: 100%; height: auto;" /></font></a></div>
										</div>
										<!-- padding --><div style="height: 20px; line-height: 20px; font-size: 10px;">&nbsp;</div>
										<div style="line-height: 21px; padding: 0 10px;">
											<font face="Arial, Helvetica, sans-serif" size="3" color="#727272" style="font-size: 15px;">
											<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #727272; text-transform: uppercase;">
												<div id="block14" contenteditable="true"><a href="#" target="_blank" style="color: #727272; text-decoration: none;">Nonumy nibh elit</a></div>
											</span></font>
										</div>
										<!-- padding --><div style="height: 5px; line-height: 5px; font-size: 10px;">&nbsp;</div>
										<div style="line-height: 21px; padding: 0 10px;">
											<font face="Arial, Helvetica, sans-serif" size="5" color="#727272" style="font-size: 18px;">
											<strong style="font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 18px; color: #727272;">
												<div id="block15" contenteditable="true">$680</div>
											</strong></font>
										</div>
										<!-- padding --><div style="height: 30px; line-height: 30px; font-size: 10px;">&nbsp;</div>
									</div>
						...
						<tr><td align="center" style="line-height: 14px; padding: 0 10px;">
                            ...
                            <div id="block16" contenteditable="true">						
								<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
									...
									<img src="http://artloglab.com/metromail-shop/images/brand.jpg" width="150" alt="Brand" border="0" class="mob_width_50" style="display: block; width: 100%; height: auto;" /></font></a></div>
							</div>
							<!-- padding --><div style="height: 20px; line-height: 20px; font-size: 10px;">&nbsp;</div>
						</td></tr>
					</table>
			...
			<tr><td align="center">
				<div style="line-height: 27px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 27px; color: #717171;">
						<div id="block19" contenteditable="true">Need help? Call us!</div>
					</span></font>
				</div>
				...
				<div style="line-height: 27px;">
					...
					<strong style="font-family: Arial, Helvetica, sans-serif; font-size: 27px; color: #f54c57;">
						<div id="block20" contenteditable="true">873-426-0028</div>
					</strong></font>
				</div>
			</td></tr>
		</table>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #717171;">
					<div id="block21" contenteditable="true">2015 &copy; Metronic. ALL Rights Reserved.</div>
				</span></font>				
			</td></tr>			
		</table>
