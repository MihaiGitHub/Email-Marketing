...
?>" width="393" height="30" border="0" alt=""/></td>
         ...
         <tr>
          <td align="center"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#68696a; font-size:36px; text-transform:uppercase"><strong><div class='inline-edit'>
							<div class='display'><?php echo (array_key_exists(-8, $fields)) ? nl2br($fields[-8]) : 'NEWSLETTER'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="95%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="35" align="left" valign="middle" style="border-bottom:2px dotted #000000"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#000000; font-size:25px"><strong><em><div class='inline-edit'>
							<div class='display'><?php echo (array_key_exists(-7, $fields)) ? nl2br($fields[-7]) : 'Main Feature Story'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
						...
						</div></em></strong></font></td>
                          </tr>
                          <tr>
                            <td align="left" valign="top"><font style="font-family: Verdana, Geneva, sans-serif; color:#000000; font-size:13px; line-height:21px"><div class='inline-edit'>
							<div class='display'><?php echo (array_key_exists(-6, $fields)) ? nl2br($fields[-6]) : 'Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio t non'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
...
<a data-toggle="modal" data-id="5" data-value="value" class="editlist" style="color:#7bb40f; text-decoration:none" href="#editModal"><strong><em>read more} </em></strong></a>						
		...
		<a data-toggle="modal" data-id="5" data-value="" class="editlist" href="#editModal"><i class='icon-pencil'></i></a>
<a data-toggle="modal" data-id="9" class="deletelist" href="#myModal"><i class='icon-remove'></i></a>
...
$j(document).on("click", ".deletelist", function () {
     ...
     $j(".modal-body #listid").val( listid );
});
...
$j(document).on("click", ".editlist", function () {
	...
	$j(".edit #listname").val( name );
						...
						<a href= "#" style="color:#7bb40f; text-decoration:none"><strong><em>read more3} </em></strong></a></font></td>
                          </tr>
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
...
?>" width="150" height="130" border="0" alt=""/></td>
							...
							<div class='display'><?php echo (array_key_exists(-4, $fields)) ? nl2br($fields[-4]) : 'Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quisn'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
						...
						</div></font> <font style="font-family:Verdana, Geneva, sans-serif; color:#7bb40f; font-size:12px; line-height:20px"><a href= "#" style="color:#7bb40f; text-decoration:none"><strong><em>read more} </em></strong></a></font><font style="font-family: Verdana, Geneva, sans-serif; color:#000000; font-size:13px; line-height:21px">&nbsp; </font></td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr>
...
?>" alt="buy her" width="181" height="144" border="0"/></a> */ ?>
						  ...
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td align="center"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#ffffff; font-size:16px"><strong><div class='inline-edit'>
							<div class='display'><?php echo (array_key_exists(-1, $fields)) ? nl2br($fields[-1]) : 'SPECIAL COLUMN'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
                                  ...
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td align="left" valign="top"><font style="font-family: Georgia, 'Times New Roman', Times, serif; color:#ffffff; font-size:14px; line-height:21px"><div class='inline-edit'>
							<div class='display'><?php echo (array_key_exists(0, $fields)) ? nl2br($fields[0]) : 'Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum,'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
						...
						</div> <font style="font-family:Verdana, Geneva, sans-serif; color:#ffffff; font-size:12px; line-height:20px"><a href= "#" style="color:#ffffff; text-decoration:none"><strong><em>read more} </em></strong></a></font></font></td>
                                    <td>&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
        ...
        <tr>
          <td align="center"><font style="font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#231f20; font-size:8px"><strong><div class='inline-edit'>
							<div class='display'><?php echo (array_key_exists(1, $fields)) ? nl2br($fields[1]) : 'Head Office &amp; Registered Office | Company name Ltd, Adress Line, Company Street, City, State, Zip Code | Tel: 123 555 555 | customercare@company.com'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
