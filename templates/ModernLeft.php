  	<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" style="padding: 35px 0; background:#F0F0F0" bgcolor="#4b4b4b">
		  <tr>
		  	<td align="center" style="margin: 0; padding: 0;">
			    <table cellpadding="0" cellspacing="0" border="0" align="center" width="600" style="font-family: Helvetica, Arial, sans-serif;background:#2a2a2a;" class="header">
			        ...
			        <td width="580" align="left" style="padding: 18px 0 10px;">
						<h1 style="color: #47c8db !important; font: bold 32px Helvetica, Arial, sans-serif; margin: 0; padding: 0; line-height: 40px;"><div class='inline-edit'>
							<div class='display'><?php echo (array_key_exists(-9, $fields)) ? nl2br($fields[-9]) : 'Enter Title Here'; ?>
							</div>
							<div class='form'>
				...
				<table cellpadding="0" cellspacing="0" border="0" align="center" width="600" style="font-family: Helvetica, Arial, sans-serif; background: #fff url('images/bg_table.png') repeat-y;" bgcolor="#fff">
					...
					<td width="186" valign="top" align="left" style="font-family: Helvetica, Arial, sans-serif; background: #fff url('images/bg_table.png') repeat-y;" bgcolor="#fff" class="sidebar">
						<table cellpadding="0" cellspacing="0" border="0" style="color: #717171; font: normal 11px Helvetica, Arial, sans-serif; margin: 0; padding: 0;" width="186">
						<tr>
							<td valign="top" style="padding: 7px 7px 15px 20px;">			
						...
						<tr>
							...
							<div class='display'><?php echo (array_key_exists(-8, $fields)) ? nl2br($fields[-8]) : 'In other news'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
							...
							<div class='display'><?php echo (array_key_exists(-7, $fields)) ? nl2br($fields[-7]) : 'Description goes here'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
					...
					<td width="414" valign="top" align="left" style="font-family: Helvetica, Arial, sans-serif; padding: 25px 0 0;" class="content">
						...
						<tr>
							...
							<div class='display'><?php echo (array_key_exists(-6, $fields)) ? nl2br($fields[-6]) : 'Enter Title Here'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
								...
								<tr>
									...
									<td style="padding: 10px 0 8px;" valign="top">
										...
										<p><div class='inline-edit'>
							<div class='display'><?php echo (array_key_exists(-5, $fields)) ? nl2br($fields[-5]) : 'Enter description here.'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
								...
								<tr>
									<td width="22" style="font-size: 1px; line-height: 1px;"></td>
									<td style="padding: 5px 0 0 0" valign="top">
