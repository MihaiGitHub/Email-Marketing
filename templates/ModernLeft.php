				...
				<table cellpadding="0" cellspacing="0" border="0" align="center" width="600" style="font-family: Helvetica, Arial, sans-serif; background: #fff url('images/bg_table.png') repeat-y;" bgcolor="#fff">
					...
					<td width="186" valign="top" align="left" style="font-family: Helvetica, Arial, sans-serif; background: #fff url('images/bg_table.png') repeat-y;" bgcolor="#fff" class="sidebar">
						...
						<tr>
							...
							<div class='display'><?php echo (array_key_exists(2, $fields)) ? nl2br($fields[2]) : 'In other news'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
							...
							<div class='display'><?php echo (array_key_exists(3, $fields)) ? nl2br($fields[3]) : 'Description goes here'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
					...
					<td width="414" valign="top" align="left" style="font-family: Helvetica, Arial, sans-serif; padding: 25px 0 0;" class="content">
						...
						<tr>
							...
							<div class='display'><?php echo (array_key_exists(4, $fields)) ? nl2br($fields[4]) : 'Enter Title Here'; ?>
							</div>
							<div class='form'>
								<div><div><textarea class='text'></textarea></div></div>
								<div>
