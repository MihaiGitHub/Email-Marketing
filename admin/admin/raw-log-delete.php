...
if (isset($_POST["Delete_x"])) // Trigger
{
  ...
  $WA_table = $db_table_prefix . "raw_log";
  $WA_redirectURL = "raw-log-results.php";
...
<title>Delete PayPal IPN Raw Data Log</title>
...
<div id="container">
  ...
  <div id="content">
    <div class="WADADeleteContainer">
      ...
      <form action="raw-log-delete.php?id=<?php echo(rawurlencode($row_WADApaypal_raw_log['id'])); ?>" method="post" name="WADADeleteForm" id="WADADeleteForm">
        ...
        <table class="WADADataTable" cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td class="WADADataTableCell"><?php echo($row_WADApaypal_raw_log['id']); ?></td>
          </tr>
          <tr>
            <th class="WADADataTableHeader">Created Date</th>
            <td class="WADADataTableCell"><?php echo($row_WADApaypal_raw_log['created_timestamp']); ?></td>
          </tr>
          <tr>
            <th class="WADADataTableHeader">IPN Data</th>
            <td class="WADADataTableCell"><?php echo($row_WADApaypal_raw_log['ipn_data_serialized']); ?></td>
          </tr>
        </table>
        <div class="WADAHorizLine"><img src="../WA_DataAssist/images/_tx_.gif" alt="" height="1" width="1" border="0" /></div>
        <div class="WADAButtonRow">
          <table class="WADADataNavButtons" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td class="WADADataNavButtonCell" nowrap="nowrap"><a href="raw-log-results.php" title="Cancel"><img border="0" name="Cancel" id="Cancel" alt="Cancel" src="../WA_DataAssist/images/Pacifica/Refined_cancel.gif" /></a></td>
            </tr>
          </table>
          <input name="WADADeleteRecordID" type="hidden" id="WADADeleteRecordID" value="<?php echo(rawurlencode($row_WADApaypal_raw_log['id'])); ?>" />
        </div>
      </form>
