...
if(array_key_exists('timeout', $_GET)){
	$errorMessage = 'You have been logged out due to inactivity. Please log in.';
}
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	if($_SESSION['auth']){
		...
		$red = 'Username or password does not match.';	
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="navbar">
	    ...
	    <div class="dialog">
		   <div class="block">
			  ...
			  <?php if(isset($red)) echo '<div class="n_error">Invalid username or password</div>'; ?>
